...
// console.log(programa.fabricante.filiais.length); // ReferrenceError
...
// Instanciação de Objetos - Forma 4 - Objeto Literal
...
// Instanciação de Objetos - Forma 5 - Objeto Literal
